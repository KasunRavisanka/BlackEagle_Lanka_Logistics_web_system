...
// 3. Relevant Functions Control    
    ...
    $functions_idCompletedTrips = $_GET["functions_idCompletedTrips"];
...
// 6. Relevant Functions Execution Control
    ...
    $getAllClassOfVehicleTabResult1 = $vehicleObj->getAllClassOfVehicle();
    $getAllClassOfVehicleTabResult2 = $vehicleObj->getAllClassOfVehicle();
    
    $getActiveTabClassOfVehicleResult = $vehicleObj->getActiveTabClassOfVehicle();
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdCompletedTripsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdCompletedTrips($functions_idCompletedTrips);
    $getSpecificFunctionRelevatFunctionIdCompletedTrips = $getSpecificFunctionRelevatFunctionIdCompletedTripsResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdCompletedTrips["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdCompletedTrips["functions_name"];?></h4>
            </div>
            <div class="row">

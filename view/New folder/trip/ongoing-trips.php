...
// 3. Relevant Functions Control    
    ...
    $functions_idOngingTrips = $_GET["functions_idOngingTrips"];
...
// 6. Relevant Functions Execution Control
    $getOngingTripsResult = $TripAndRouteObj->getOngingTrips();
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdOngoingTripsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdOngoingTrips($functions_idOngingTrips);
    $getSpecificFunctionRelevatFunctionIdOngoingTrips = $getSpecificFunctionRelevatFunctionIdOngoingTripsResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdOngoingTrips["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdOngoingTrips["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getOngingTrips = $getOngingTripsResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getOngingTrips["trip_name"]); ?></td>

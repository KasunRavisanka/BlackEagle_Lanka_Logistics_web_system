...
// 3. Relevant Functions Control    
    ...
    $functions_idAllTrips = $_GET["functions_idAllTrips"];
...
// 6. Relevant Functions Execution Control
    $getAllTripsResult = $TripAndRouteObj->getAllTrips();
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdAllTripsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdAllTrips($functions_idAllTrips);
    $getSpecificFunctionRelevatFunctionIdAllTrips = $getSpecificFunctionRelevatFunctionIdAllTripsResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdAllTrips["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdAllTrips["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getAllTrips = $getAllTripsResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getAllTrips["trip_name"]); ?></td>
                                <td><?php echo ucwords($getAllTrips["trip_status_name"]); ?></td>

...
// 3. Relevant Functions Control    
    ...
    $functions_idCancelledTrips = $_GET["functions_idCancelledTrips"];
...
// 6. Relevant Functions Execution Control
    $getCancelledTripsResult = $TripAndRouteObj->getCancelledTrips();
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdCancelledTripsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdCancelledTrips($functions_idCancelledTrips);
    $getSpecificFunctionRelevatFunctionIdCancelledTrips = $getSpecificFunctionRelevatFunctionIdCancelledTripsResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdCancelledTrips["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdCancelledTrips["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getCancelledTrips = $getCancelledTripsResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getCancelledTrips["trip_name"]); ?></td>

...
// 3. Relevant Functions Control    
    ...
    $functions_idRims = $_GET["functions_idRims"];
...
// 6. Relevant Functions Execution Control    
    ...
    $getAllNewRimsResult = $maintenanceObj->getAllNewRims();
...
// 7. Functions ID Control    
    ...
    $getSpecificFunctionRelevatFunctionIdRimsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdRims($functions_idRims);
    $getSpecificFunctionRelevatFunctionIdRims = $getSpecificFunctionRelevatFunctionIdRimsResult->fetch_assoc();
...
// 10. Breadcrumb Control    
    ...
    $d5 = $getSpecificFunctionRelevatFunctionIdRims["functions_name"];
    $d6 = '';
    $d7 = '';
?>
<head>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdRims["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-bordered" id="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Rim Name</th>
                            <th scope="col">Rim Position</th>
                            <th scope="col">Rim Brand</th>
                            <th scope="col">Rim Available Stock</th>
                            <th scope="col">Rim Stock Max</th>
                            <th scope="col">Rim Stock Min</th>
                            <th scope="col">Rim Arrived Stock</th>
     ...
     <?php  
                        while($getAllNewRimsRow = $getAllNewRimsResult->fetch_assoc()){
                            $selectedNewRimsImg="";
                            if($getAllNewRimsRow["new_rims_images"]==""){
                                $selectedNewRimsImg = "../../images/new_rims_images/download.jpeg";
                            }
                            else{
                                $selectedNewRimsImg = "../../images/new_rims_images/".$getAllNewRimsRow["new_rims_images"];
                            }

    ?>                       
                            <tr>
                                <td><?php echo $number;?></td>
                                <td scope="row"><img class="rounded-circle" src="<?php echo $selectedNewRimsImg;?>" width="80px"/></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_name"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_positions_name"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_brands_name"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_available_stocks"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_stocks_max"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_stocks_min"]);?></td>
                                <td><?php echo ucwords($getAllNewRimsRow["new_rims_arrived_stocks"]);?></td>
                            </tr> 
    <?php
                            $number = $number + 1;
                        }

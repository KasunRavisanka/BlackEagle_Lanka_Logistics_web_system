...
// 3. Relevant Functions Control    
    ...
    $functions_idVehicleMaintenance = $_GET["functions_idVehicleMaintenance"];
    $functions_modules_id = 41;
...
<head>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdVehicleMaintenance["functions_name"];?></h4>
            </div>
        </div>
    </body>
    <?php

...
// 3. Relevant Functions Control    
    ...
    $functions_idVehicleSpareParts = $_GET["functions_idVehicleSpareParts"];
...
<head>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdVehicleSpareParts["functions_name"];?></h4>
            </div>
        </div>
    </body>
    <?php

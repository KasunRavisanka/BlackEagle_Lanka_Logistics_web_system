...
// 3. Relevant Functions Control    
    ...
    $functions_idNuts = $_GET["functions_idNuts"];
...
// 6. Relevant Functions Execution Control    
    ...
    $getAllNewNutsResult = $maintenanceObj->getAllNewNuts();
...
// 7. Functions ID Control    
    ...
    $getSpecificFunctionRelevatFunctionIdNutsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdNuts($functions_idNuts);
    $getSpecificFunctionRelevatFunctionIdNuts = $getSpecificFunctionRelevatFunctionIdNutsResult->fetch_assoc();
...
// 10. Breadcrumb Control    
    ...
    $d5 = $getSpecificFunctionRelevatFunctionIdNuts["functions_name"];
    $d6 = '';
    $d7 = '';
?>
<head>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdNuts["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-bordered" id="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Nut Name</th>
                            <th scope="col">Nut Brand</th>
                            <th scope="col">Nut Available Stock</th>
                            <th scope="col">Nut Stock Max</th>
                            <th scope="col">Nut Stock Min</th>
                            <th scope="col">Nut Arrived Stock</th>
     ...
     <?php  
                        while($getAllNewNutsRow = $getAllNewNutsResult->fetch_assoc()){
                            $selectedNewNutsImg="";
                            if($getAllNewNutsRow["new_nuts_images"]==""){
                                $selectedNewNutsImg = "../../images/new_nuts_images/download.jpeg";
                            }
                            else{
                                $selectedNewNutsImg = "../../images/new_nuts_images/".$getAllNewNutsRow["new_nuts_images"];
                            }

    ?>                       
                            <tr>
                                <td><?php echo $number;?></td>
                                <td scope="row"><img class="rounded-circle" src="<?php echo $selectedNewNutsImg;?>" width="60px"/></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_name"];?></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_brands_name"];?></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_available_stocks"];?></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_stocks_max"];?></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_stocks_min"];?></td>
                                <td><?php echo $getAllNewNutsRow["new_nuts_arrived_stocks"];?></td>
                            </tr> 
    <?php
                            $number = $number + 1;
                        }

...
<?php
    ...
    $functions_idViewUnregisteredCustomers = $_GET["functions_idViewUnregisteredCustomers"];
    ...
    $getSpecificFunctionRelevatFunctionIdViewUnregisteredCustomersResult = $functionsObj->getSpecificFunctionRelevatFunctionIdViewUnregisteredCustomers($functions_idViewUnregisteredCustomers);
    $getSpecificFunctionRelevatFunctionIdViewUnregisteredCustomers = $getSpecificFunctionRelevatFunctionIdViewUnregisteredCustomersResult->fetch_assoc();
    
    $getAllUnregisteredCustomersResult = $customerObj->getAllUnregisteredCustomers();
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdViewUnregisteredCustomers["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center">View Unregistered Customers</h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    &nbsp;
            ...
            <div class="row">
                <table class="table table-hover table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                    while($getAllUnregisteredCustomersRow = $getAllUnregisteredCustomersResult->fetch_assoc()){
                        $selectedClientImg="";
                        if($getAllUnregisteredCustomersRow["client_client_image"]==""){                            
                            $selectedClientImg = "../../images/client_images/download.jpeg";
                        }
                        else{
                            $selectedClientImg = "../../images/client_images/".$getAllUnregisteredCustomersRow["client_client_image"];
                        }
                        $selectedComapnyImg="";
                        if($getAllUnregisteredCustomersRow["client_company_image"]==""){                            
                            $selectedComapnyImg = "../../images/company_images/download.jpeg";
                        }
                        else{
                            $selectedComapnyImg = "../../images/company_images/".$getAllUnregisteredCustomersRow["client_company_image"];
                        }
...
//                            $driver_id = base64_encode($driver_id);
    ?>  
                        <tr>
                            <td scope="row">
                                <a href="view-specific-driver.php?driver_id=<?php echo $getAllUnregisteredCustomersRow["client_id"];?>&module_id=<?php echo $module_id;?>&functions_idViewRegisteredCustomers=<?php echo $functions_idViewRegisteredCustomers;?>&functions_idViewSpecificDriver=23">
                                    <img class="rounded-circle" src="<?php echo $selectedClientImg;?>" height="30px"/>
                                </a>
                            </td>
                            <td><?php echo ucwords($getAllUnregisteredCustomersRow["client_client_othername"]);?></td>
                            <td><?php echo ucwords($getAllUnregisteredCustomersRow["client_company_name"]);?></td>
                            <td>
                                <a>
                                    <img class="rounded-circle" src="<?php echo $selectedComapnyImg;?>" height="30px"/>
                                </a>
                            </td>
                            <!--<td><?php echo ucwords($getAllUnregisteredCustomersRow["client_client_email"]);?></td>-->
                            <!--<td><?php echo ucwords($getAllUnregisteredCustomersRow["client_client_prof"]);?></td>-->
                        </tr>    
    <?php
                        }
    ?>

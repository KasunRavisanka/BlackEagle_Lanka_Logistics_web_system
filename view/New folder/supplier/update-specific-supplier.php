...
// 3. Relevant Functions Control    
    ...
    $functions_idUpdateSpecificSupplier = $_GET["functions_idUpdateSpecificSupplier"];
...
// 7. Functions ID Control
    ...
    $getSpecificFunctionRelevatFunctionIdUpdateSpecificSupplierResult = $functionsObj->getSpecificFunctionRelevatFunctionIdUpdateSpecific($functions_idUpdateSpecificSupplier);
    $getSpecificFunctionRelevatFunctionIdUpdateSpecificSupplier = $getSpecificFunctionRelevatFunctionIdUpdateSpecificSupplierResult->fetch_assoc();
    
// 8. Function Module Control
    $moduleType="functions";
    
// 9. Image Control
    $selectedUpdateSpecificSupplierImg = "";
    if($getSpecificSupplierRow["supplier_logo"]==""){
        $selectedUpdateSpecificSupplierImg = "../../images/supplier_images/download.jpeg";
    }else{
        $selectedUpdateSpecificSupplierImg = "../../images/supplier_images/".$getSpecificSupplierRow["supplier_logo"];
    }
...
// 10. Breadcrumb Control
    ...
    $column4Result = $breadcrumbObj->viewBreadcrumbRow(30);
    ...
    $e3 = "&functions_idViewSpecificSupplier=".$functions_idViewSpecificSupplier;
    $e4 = "&supplier_id=".$supplier_id;
    ...
    $d5 = $getSpecificFunctionRelevatFunctionIdUpdateSpecificSupplier["functions_name"];
    $d6 = '';
    $d7 = '';
?>
    <head>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center">Update - <?php echo $getSpecificSupplierRow["supplier_name"];?></h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <img class="rounded mx-auto d-block" src="<?php echo $selectedUpdateSpecificSupplierImg?>" width="200px"/>
                </div>             
            </div>
            <div class="row">
                <div class="col-md-12">&nbsp;</div>
            </div>
            <form action="../../controller/controller/supplier_controller.php?status=update_specific_supplier&module_id=<?php echo $module_id;?>&supplier_id=<?php echo $supplier_id;?>&functions_idViewSuppliers=<?php echo $functions_idViewSuppliers;?>&functions_idViewSpecificSupplier=<?php echo $functions_idViewSpecificSupplier;?>" method="post" enctype="multipart/form-data">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="row">    
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="supplierName" id="supplierName" value="<?php echo $getSpecificSupplierRow["supplier_name"];?>"/>
                        </div>     
                        <div class="col-md-3">
                            <label class="control-label">2. Supplier Email</label>
                        </div>
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="supplierEmail" id="supplierEmail" value="<?php echo $getSpecificSupplierRow["supplier_email"];?>"/>
                        </div> 
                    </div> 
                    <div class="row">
                        <div class="col-md-12">&nbsp;</div>
            ...
            <!--Signature of the Holder-->
                        <div class="col-md-3">
                            <label class="control-label">3. Supplier Logo</label>
                        </div>
                        <div class="col-md-3">
                            <input type="file" class="form-control" name="supplierLogo" id="supplierLogo" value="<?php echo $selectedUpdateSpecificSupplierImg; ?>" onchange="readURLupdateSpecificSupplierImage(this)"/>
                            <img src="<?php echo $selectedUpdateSpecificSupplierImg; ?>" width="100" id="updateSpecificSupplierImagePrev"/>
                        </div>                                                             
                    </div>
                    <div class="row">
                        <div class="col-md-12">&nbsp;</div>
    ...
    <script type="text/javascript">     
        function readURLupdateSpecificSupplierImage(input){
            if(input.files && input.files[0]){
                var reader = new FileReader();
                reader.onload = function(e){
                    $('#updateSpecificSupplierImagePrev')

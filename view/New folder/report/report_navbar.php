        ...
        <nav class="navbar sticky-top bg-dark d-flex p-0 shadow" data-bs-theme="dark">
            ...
            <ul class="navbar-nav flex p-0">
                <li class="nav-item text-nowrap">
                    <button class="nav-link px-3 text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#reportSidebarMenu" aria-controls="reportSidebarMenu" aria-expanded="false" aria-label="Toggle navigation">

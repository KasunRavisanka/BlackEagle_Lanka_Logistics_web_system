...
// 3. Relevant Functions Control    
    ...
    $functions_idFinishedCargoShipmentProcess = $_GET["functions_idFinishedCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getFinishedCargoShipmentProcessResult = $CargoAndShipmentObj->getFinishedCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcess($functions_idFinishedCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcess = $getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdFinishedCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getFinishedCargoShipmentProcess = $getFinishedCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getFinishedCargoShipmentProcess["cargo_and_shipment_process_name"]); ?></td>

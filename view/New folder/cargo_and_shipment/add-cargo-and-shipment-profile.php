...
// 3. Relevant Functions Control    
    ...
    $functions_idAddCargoAndShipmentProfile = $_GET["functions_idAddCargoAndShipmentProfile"];
...
// 6. Relevant Functions Execution Control
    $getAllWarehouseWithoutCargoAndShipmentResult = $warehouseObj->getAllWarehouseWithoutCargoAndShipment();   

// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfileResult = $functionsObj->getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfile($functions_idAddCargoAndShipmentProfile);
    $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfile = $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfileResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfile["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfile["functions_name"];?></h4>
            </div>
            ...
            <div class="row px-3">
                <table class="table table-hover table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getAllWarehouseWithoutCargoAndShipment = $getAllWarehouseWithoutCargoAndShipmentResult->fetch_assoc()){
                            $selectedWarehouseSectionsImg="";
                            if($getAllWarehouseWithoutCargoAndShipment["warehouseImage_"]==""){
                                $selectedWarehouseSectionsImg = "../../images/fleet_images/download.jpeg";
                            }else{
                                $selectedWarehouseSectionsImg = "../../images/warehouse_images/".$getAllWarehouseWithoutCargoAndShipment["warehouseImage_"];
                            }
    ?>
                            <tr>
                                ...
                                <td><?php echo ucwords($getAllWarehouseWithoutCargoAndShipment["warehouseName"]); ?></td>
                                <td><?php echo ucwords($getAllWarehouseWithoutCargoAndShipment["cityOfTheWarehouseLocated"]); ?></td>
                            </tr> 
    <?php 
                            $number = $number + 1;
                        }

...
// 3. Relevant Functions Control    
    ...
    $functions_idPendingUnpackingCargoShipmentProcess = $_GET["functions_idPendingUnpackingCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getPendingUnpackingCargoShipmentProcessResult = $CargoAndShipmentObj->getPendingUnpackingCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcess($functions_idPendingUnpackingCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcess = $getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionPendingUnpackingCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getPendingUnpackingCargoShipmentProcess = $getPendingUnpackingCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getPendingUnpackingCargoShipmentProcess["unpacking_cargo_and_shipment_process_name"]); ?></td>

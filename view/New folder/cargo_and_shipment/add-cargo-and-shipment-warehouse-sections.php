...
// 6. Relevant Functions Execution Control
    $getAllCargoAndShipmentProfileResult = $CargoAndShipmentObj->getAllCargoAndShipmentProfile();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdAddCargoAndShipmentProfileWarehouseSections["functions_name"]." Page 1";
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row px-3">
                <h5 style="text-align:start">Select Cargo and Shipment Profile</h5>
            </div>
            <div class="row px-3">
                <table class="table table-hover table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getAllCargoAndShipmentProfile = $getAllCargoAndShipmentProfileResult->fetch_assoc()){
    ...
    ?>
                            <tr>
                                ...
                                <td scope="row">                                   
                                    <a href="add-cargo-and-shipment-warehouse-sections-page-2.php?status=addCargoAndShipmentForWarehouse&warehouse_id=<?php echo $getAllCargoAndShipmentProfile["warehouse_id"];?>&cargo_and_shipment_id=<?php echo $getAllCargoAndShipmentProfile["cargo_and_shipment_id"];;?>&module_id=<?php echo $module_id;?>&functions_idAddCargoAndShipmentProfileWarehouseSections=<?php echo $functions_idAddCargoAndShipmentProfileWarehouseSections;?>&functions_idAddCargoAndShipmentProfileWarehouseSectionsPage2=125">
                                        <img class="rounded-circle" src="<?php echo $selectedWarehouseSectionsImg ?>" width="35px" height="35px"/>
                                    </a>
                                </td>
                                <td><?php echo ucwords($getAllCargoAndShipmentProfile["cargo_and_shipment_name"]); ?></td>
                                <td><?php echo ucwords($getAllCargoAndShipmentProfile["cityOfTheWarehouseLocated"]); ?></td>
                            </tr> 
    <?php 
                            $number = $number + 1;
                        }

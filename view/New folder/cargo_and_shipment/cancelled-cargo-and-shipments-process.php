...
// 3. Relevant Functions Control    
    ...
    $functions_idCancelledCargoShipmentProcess = $_GET["functions_idCancelledCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getCancelledCargoShipmentProcessResult = $CargoAndShipmentObj->getCancelledCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcess($functions_idCancelledCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcess = $getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionCancelledCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getCancelledCargoShipmentProcess = $getCancelledCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getCancelledCargoShipmentProcess["cargo_and_shipment_process_name"]); ?></td>

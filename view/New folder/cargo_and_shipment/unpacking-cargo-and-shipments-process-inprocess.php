...
// 3. Relevant Functions Control    
    ...
    $functions_idInProcessUnpackingCargoShipmentProcess = $_GET["functions_idInProcessUnpackingCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getInProcessUnpackingCargoShipmentProcessResult = $CargoAndShipmentObj->getInProcessUnpackingCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcess($functions_idInProcessUnpackingCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcess = $getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionInProcessUnpackingCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Cargo and Shipment Process Name</th>
                    ...
                    <tbody>
    <?php
                        while($getInProcessUnpackingCargoShipmentProcess = $getInProcessUnpackingCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getInProcessUnpackingCargoShipmentProcess["unpacking_cargo_and_shipment_process_name"]); ?></td>

...
// 3. Relevant Functions Control    
    ...
    $functions_idInprocessCargoShipmentProcess = $_GET["functions_idInprocessCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getInProcessCargoShipmentProcessResult = $CargoAndShipmentObj->getInProcessCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcess($functions_idInprocessCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcess = $getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdInProcessCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getInProcessCargoShipmentProcess = $getInProcessCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getInProcessCargoShipmentProcess["cargo_and_shipment_process_name"]); ?></td>

...
// 3. Relevant Functions Control    
    ...
    $functions_idFinishedUnpackingCargoShipmentProcess = $_GET["functions_idFinishedUnpackingCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getFinishedUnpackingCargoShipmentProcess = $CargoAndShipmentObj->getFinishedUnpackingCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcess($functions_idFinishedUnpackingCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcess = $getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionFinishedUnpackingCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getFinishedUnpackingCargoShipment = $getFinishedUnpackingCargoShipmentProcess->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getFinishedUnpackingCargoShipment["unpacking_cargo_and_shipment_process_name"]); ?></td>

...
// 3. Relevant Functions Control    
    ...
    $functions_idPendingCargoShipmentProcess = $_GET["functions_idPendingCargoShipmentProcess"];
...
//    $getFinishedBookingsResult = $bookingObj->getFinishedBookings();
    $getPendingCargoShipmentProcessResult = $CargoAndShipmentObj->getPendingCargoShipmentProcess();   
    
    
// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcessResult = $functionsObj->getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcess($functions_idPendingCargoShipmentProcess);
    $getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcess = $getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcessResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcess["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdPendingCargoShipmentProcess["functions_name"];?></h4>
            </div>
            <div class="row">
                <table class="table table-hover table-responsive table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getPendingCargoShipmentProcess = $getPendingCargoShipmentProcessResult->fetch_assoc()){
...
<!--                                <td scope="row">                                   
                                ...
                                <td><?php echo ucwords($getPendingCargoShipmentProcess["cargo_and_shipment_process_name"]); ?></td>

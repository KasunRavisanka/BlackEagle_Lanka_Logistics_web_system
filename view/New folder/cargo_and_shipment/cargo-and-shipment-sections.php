...
// 3. Relevant Functions Control    
    ...
    $functions_idCargoAndShipmentSections = $_GET["functions_idCargoAndShipmentSections"];
...
// 6. Relevant Functions Execution Control
    $getAllCargoAndShipmentSectionsResult = $CargoAndShipmentObj->getAllCargoAndShipmentSections();   

// 7. Functions ID Control    
    $getSpecificFunctionRelevatFunctionIdCargoAndShipmentSectionsResult = $functionsObj->getSpecificFunctionRelevatFunctionIdCargoAndShipmentSections($functions_idCargoAndShipmentSections);
    $getSpecificFunctionRelevatFunctionIdCargoAndShipmentSections = $getSpecificFunctionRelevatFunctionIdCargoAndShipmentSectionsResult->fetch_assoc();
...
// 10. Breadcrumb Control
    ...
    $d3 = $getSpecificFunctionRelevatFunctionIdCargoAndShipmentSections["functions_name"];
    $d4 = '';
    $d5 = '';
    $d6 = '';
    $d7 = '';
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdCargoAndShipmentSections["functions_name"];?></h4>
            </div>
                ...
                <table class="table table-hover table-bordered" id="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Cargo and Shipment Section Name</th>
                    ...
                    <tbody>
    <?php
                        while($getAllCargoAndShipmentSections = $getAllCargoAndShipmentSectionsResult->fetch_assoc()){
...
//                            }
    ?>
                            <tr>
                                ...
                                <td><?php echo ucwords($getAllCargoAndShipmentSections["cargo_and_shipment_section_name"]); ?></td>
                                <td><?php echo ucwords($getAllCargoAndShipmentSections["cargo_and_shipment_name"]); ?></td>

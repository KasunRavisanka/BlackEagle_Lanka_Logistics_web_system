...
// 6. Relevant Functions Execution Control
    $getAllCargoAndShipmentForWarehouseResult = $CargoAndShipmentObj->getAllCargoAndShipmentForWarehouse();   
    ...
    ?> 
            ...
            <div class="row px-3">
                <table class="table table-hover table-bordered" id="table">
                    ...
                    <tbody>
    <?php
                        while($getAllCargoAndShipmentForWarehouse = $getAllCargoAndShipmentForWarehouseResult->fetch_assoc()){
...
//                            }
    ?>
                            <tr>
                                ...
                                <td><?php echo ucwords($getAllCargoAndShipmentForWarehouse["cargo_and_shipment_name"]); ?></td>
                                <td>
                                    <a class="btn btn-primary" href="cargo-and-shipment-for-warehouse-specific-section.php?status=addCargoAndShipmentForWarehouse&cargo_and_shipment_id=<?php echo $getAllCargoAndShipmentForWarehouse["cargo_and_shipment_id"];?>&module_id=<?php echo $module_id;?>&functions_idCargoAndShipmentForWarehouse=<?php echo $functions_idCargoAndShipmentForWarehouse;?>&functions_idCargoAndShipmentForWarehouseSpecificSection=127">
                                        Select
                                    </a>
                                </td>

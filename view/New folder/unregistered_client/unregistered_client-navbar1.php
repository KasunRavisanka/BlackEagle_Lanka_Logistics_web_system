...
<html>
    ...
    <?php
        if(isset($_SESSION)){
            $selectedUserImg = "../../images/user_images/download.jpeg";
        }else{
            $selectedUserImg = "../../images/user_images/download.jpeg";
        }
    ?>
        <nav class="navbar sticky-top bg-dark d-flex p-0 shadow" data-bs-theme="dark">
            <!--<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Company name</a>-->      
            <ul class="navbar-nav flex p-0">
                <li class="nav-item text-nowrap">
                    <!--<button class="nav-link px-3 text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#maintainSidebarMenu" aria-controls="maintainSidebarMenu" aria-expanded="false" aria-label="Toggle navigation">-->
                    <button class="nav-link px-3 text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="<?php echo $getFunctionsModulesById["functions_modules_data-bs-target"];?>" aria-controls="<?php echo $getFunctionsModulesById["functions_modules_idName"];?>" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <?php
            include '../common/profileMenu.php';
    ?> 
            <ul class="navbar-nav flex-row">
                ...
                <li class="nav-item text-nowrap">
                    <button class="nav-link px-3 text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#profileMenu" aria-controls="profileMenu" aria-expanded="false" aria-label="Toggle profile">
                        <!--<svg class="bi"><use xlink:href="#search"/></svg>-->
                        <!--<span class="navbar-toggler-icon"></span>-->
                        <img class="rounded-circle " src="<?php echo $selectedUserImg;?>" style="height: 30px; width: 30px" alt="asasassa">
                    </button>
                </li>
                <li class="nav-item text-nowrap">
...
<!--        <nav class="navbar navbar-top fixed-top navbar-expand-lg bg-body-tertiary" id="navbarDefault">
            ...
            <div class="dropdown px-3 justify-content-end">
                <a class="nav-link lh-1 pe-0 justify-content-end" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="../../images/user_images/download.jpeg" style="height: 30px; width: 30px" alt="asasassa">
                    </div>
                </a>
                        ...
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    <img class="rounded-circle " src="../../images/user_images/download.jpeg" style="height: 90px; width: 90px" alt="aaa">
                                </div>

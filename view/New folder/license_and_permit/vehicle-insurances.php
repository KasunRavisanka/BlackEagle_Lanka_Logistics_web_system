...
// 6. Relevant Functions Execution Control
    $getAllVehicleInsurancesResults = $LicenseAndPermitObj->getAllVehicleInsurances();
...
?>
    ...
    ?> 
            ...
            <div class="row">
                <h4 style="text-align:center"><?php echo $getSpecificFunctionRelevatFunctionIdVehicleInsurances["functions_name"];?></h4>
            </div>           
            <div class="row">
                ...
                <table class="table table-hover table-bordered" id="drivertable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Period of Cover</th>
                    ...
                    <tbody>
    <?php
                    while($getAllVehicleInsurances = $getAllVehicleInsurancesResults->fetch_assoc()){
                        $selectedImg = "";
                            if($getAllVehicleInsurances["vehicleImage_"]=="")
                            {
                                $selectedImg = "../../images/driver_images/download.jpeg";
                            }
                            else{
                                $selectedImg = "../../images/vehicle_images/".$getAllVehicleInsurances["vehicleImage_"];
                            }
...
//    ?>  
                        <tr>
                            ...
                            <td scope="row">
                                <a href="specific-vehicle-insurances.php?vehicle_insurances_id=<?php echo $getAllVehicleInsurances["vehicle_insurances_id"];?>&module_id=<?php echo $module_id;?>&functions_idVehicleInsurances=<?php echo $functions_idVehicleInsurances;?>&functions_idSpecificVehicleInsurance=102">
                                    <img class="rounded-circle" src="<?php echo $selectedImg ?>" width="30px" height="30px"/>
                                </a>
                            </td>
                            <td><?php echo ucwords($getAllVehicleInsurances["make"]." ".$getAllVehicleInsurances["model"]);?></td>
                            <!--<td><?php echo ucwords($driverrow["email"]); ?></td>-->
                            <td><?php echo ucwords($getAllVehicleInsurances["vehicle_no"]); ?></td>
                            <td><?php echo ucwords($getAllVehicleInsurances["periodOfStart"]." to ".$getAllVehicleInsurances["periodOfEnd"]);?></td>
                            <td><?php echo ucwords($getAllVehicleInsurances["insuranceCompanyName"]); ?></td>
